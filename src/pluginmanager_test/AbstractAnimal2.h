...
class AbstractAnimal2: public PluginManager::AbstractPlugin {
    public:
        static Containers::StringView pluginInterface() {
            using namespace Containers::Literals;
            return "cz.mosra.corrade.Examples.AbstractAnimal2/1.0"_s;
        }
        ...
        explicit AbstractAnimal2(PluginManager::AbstractManager& manager, Containers::StringView plugin):
